...
public class BuildView extends CommonContainerFixture {
    ...
    public void testIfBuildIsSuccessful() {
        String runConsoleOutput = listOfRemoteTextToString(runConsole().findAllText());
    ...
    private String getBuildStatusTreeText() {
        String buildStatusTreeText = listOfRemoteTextToString(buildStatusTree().findAllText());
